...
$lang->select_module_instance='모듈 선택';
...
$lang->about_download_link='최신 버전이 배포되었습니다. download 링크를 클릭하시면 다운 받으실 수 있습니다.';
...
$lang->detail_about_admin_ip_limit='해당 IP에 대해서만 관리자 페이지로 접근이 가능하므로 주의해주시기 바랍니다. IP대역 정보는 /files/config/db.config.php 파일에 저장됩니다. 여러개의 항목은 줄을 바꾸어 입력하세요.';
