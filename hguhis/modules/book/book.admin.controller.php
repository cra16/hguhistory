<?php
     ...
     * @brief  book 모듈의 admin controller class
     **/

    class bookAdminController extends book {
         ...
         * @brief 모듈 추가
         **/
		function procBookAdminInsertBook() {
         ...
         * @brief 모듈 삭제
         **/
        function procBookAdminDeleteBook() {
