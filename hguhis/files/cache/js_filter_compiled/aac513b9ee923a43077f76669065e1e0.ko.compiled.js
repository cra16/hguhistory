function admin_insert(form){ return legacy_filter('admin_insert', form, 'hiswiki', 'procHiswikiAdminModuleInsert', completeHiswikiAdminModuleInsert, ['error','message','module','act','page','module_srl'], '등록하시겠습니까?', {}) };
(function($){
	var v=xe.getApp('validator')[0];if(!v)return false;
	v.cast("ADD_FILTER", ["admin_insert", {'mid': {required:true,maxlength:40,rule:'alpha_number'},'browser_title': {required:true,maxlength:250}}]);
