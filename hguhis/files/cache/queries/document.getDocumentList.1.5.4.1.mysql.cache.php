...
${'s_email_addres20_argument'} = new ConditionArgument('s_email_addres', $args->s_email_addres, 'like');
${'s_email_addres20_argument'}->createConditionValue();
if(!${'s_email_addres20_argument'}->isValid()) return ${'s_email_addres20_argument'}->getErrorMessage();
} else
${'s_email_addres20_argument'} = null;if(${'s_email_addres20_argument'} !== null) ${'s_email_addres20_argument'}->setColumnType('varchar');
...
,new ConditionWithArgument('`list_order`',$last_division14_argument,"below", 'and')),'and')
,new ConditionGroup(array(
...
,new ConditionWithArgument('`email_address`',$s_email_addres20_argument,"like", 'or')
...
,new ConditionWithArgument('`ipaddress`',$s_ipaddress32_argument,"like_prefix", 'or')),'and')
,new ConditionGroup(array(
new ConditionWithArgument('`last_update`',$start_date33_argument,"more", 'and')
,new ConditionWithArgument('`last_update`',$end_date34_argument,"less", 'and')),'and')
));
