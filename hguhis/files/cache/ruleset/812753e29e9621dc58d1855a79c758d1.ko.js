...
v.cast('ADD_FILTER',['insertJoinForm', {'column_type':{required:true},'column_id':{required:true,rule:'alpha_number'},'column_title':{required:true}}]);
v.cast('ADD_MESSAGE',['column_type','형식']);
v.cast('ADD_MESSAGE',['column_id','입력항목 ID']);
