...
v.cast('ADD_FILTER',['insertConfig', {'webmaster_name':{required:true,minlength:'2',maxlength:'40'},'webmaster_email':{rule:'email',minlength:'1',maxlength:'200'},'max_error_count':{rule:'number',minlength:'1',maxlength:'20'},'max_error_count_time':{rule:'number',minlength:'1',maxlength:'20'}}]);
