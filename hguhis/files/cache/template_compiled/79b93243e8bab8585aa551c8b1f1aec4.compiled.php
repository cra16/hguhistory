<?php if(!defined("__XE__"))exit;?><form action="./" method="get" class="boardListForm"><input type="hidden" name="error_return_url" value="<?php echo htmlspecialchars(getRequestUriByServerEnviroment()) ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
    <fieldset>
...
if($__Context->sort_index=='regdate'){ ?><img src="/git/hguhistory/hguhis/modules/board/skins/xe_default/images/common/<?php echo $__Context->order_icon ?>" alt="sort" width="5" height="3" class="sort" /><?php } ?></a></th>
...
if($__Context->sort_index=='last_update'){ ?><img src="/git/hguhistory/hguhis/modules/board/skins/xe_default/images/common/<?php echo $__Context->order_icon ?>" alt="sort" width="5" height="3" class="sort" /><?php } ?></a></th>
...
if($__Context->sort_index=='readed_count'){ ?><img src="/git/hguhistory/hguhis/modules/board/skins/xe_default/images/common/<?php echo $__Context->order_icon ?>" alt="sort" width="5" height="3" class="sort" /><?php } ?></a></th>
...
if($__Context->sort_index=='voted_count'){ ?><img src="/git/hguhistory/hguhis/modules/board/skins/xe_default/images/common/<?php echo $__Context->order_icon ?>" alt="sort" width="5" height="3" class="sort" /><?php } ?></a></th>
...
if($__Context->sort_index=='blamed_count'){ ?><img src="/git/hguhistory/hguhis/modules/board/skins/xe_default/images/common/<?php echo $__Context->order_icon ?>" alt="sort" width="5" height="3" class="sort" /><?php } ?></a></th>
                        <?php } ?>
                    
                    <?php }else{ ?>
                            <th scope="col"><div><a href="<?php echo geturl('sort_index', $__Context->val->eid, 'order_type', $__Context->order_type) ?>"><?php echo $__Context->val->name;
if($__Context->sort_index == $__Context->val->eid){ ?><img src="/git/hguhistory/hguhis/modules/board/skins/xe_default/images/common/<?php echo $__Context->order_icon ?>" alt="sort" width="5" height="3" class="sort" /><?php } ?></a></div></th>
                    <?php } ?>
                <?php } ?>
            </tr>
        </thead>
