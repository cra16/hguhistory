function admin_delete(form){ return legacy_filter('admin_delete', form, 'hiswiki', 'procHiswikiAdminModuleDelete', completeHiswikiAdminModuleDelete, ['error','message','page'], '', {}) };
(function($){
	var v=xe.getApp('validator')[0];if(!v)return false;
	v.cast("ADD_FILTER", ["admin_delete", {'module_srl': {required:true}}]);
